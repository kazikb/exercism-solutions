...
def exchangeable_value(budget, exchange_rate, spread, denomination):
    ...
    new_currency = exchange_money(budget=budget,exchange_rate=actual_exchange_rate)
    number_of_bills = get_number_of_bills(amount=new_currency,denomination=denomination)
    return int(number_of_bills * denomination)